...
def decryptMessage(key, message):
    """
    Decrypts a message enciphered by a transposition cipher.
    
    Inputs: key = key of length to transpose letters by
            message = message to be enciphered.
            
    Outputs: String of message deciphered using provided key.
    """
